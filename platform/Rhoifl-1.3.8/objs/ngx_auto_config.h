#define NGX_CONFIGURE " --user=www --group=www --prefix=/usr/local/webserver/rhoifl --with-debug --with-http_stub_status_module --with-http_gzip_static_module --with-http_ssl_module --without-mail_pop3_module --without-mail_imap_module --without-http_uwsgi_module --without-http_scgi_module --without-http_ssi_module --add-module=../../rhosync/simpl-ngx_devel_kit-bc97eea --add-module=../../rhosync/chaoslawful-lua-nginx-module-3b1e9aa --add-module=../tcp_proxy_module-rho20130313"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/webserver/rhoifl/"
#endif
